...
curl_setopt($curl_handle,CURLOPT_URL,'http://www.fuelgaugereport.com/sbsavg.html');
...
/*$sql = "INSERT INTO gasprices (
		...
		$result = $dbh->query($sql);
			...
			mail($MISC['admin_email'], 'Purpool: Gas prices', $sql, "From: ".$MISC['admin_email']);
		*/
		...
		/*if (PEAR::isError($result)) 
		{
			...
			mail('john@johnkuiphoff.com', 'Purpool Error: Gas prices', $message, "From: ".$MISC['admin_email']);
		} else {
			mail('john@johnkuiphoff.com', 'Purpool Success: Gas prices', 'Gas prices have been inserted for this week', "From: ".$MISC['admin_email']);
		}*/
?>
