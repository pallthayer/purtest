package{
	...
	public class LineChart extends MovieClip{
		...
		public function LineChart(){
			...
			_grid = new Grid(500,200);
			_grid.x=_leftMargin; _grid.y=100; _grid.width=500;
			addChild(_grid);
			drawTitle("Savings");
			...
			graphMask.x=_leftMargin; graphMask.y=_grid.y;graphMask.width=_grid.width; graphMask.height=_grid.height
			addChild(graphMask);
		...
		public function drawYMarkings(maxHeight:Number,aveHeight:Number):void{
			...
			_maxField.width = 40; _aveField.width=40;
			_maxField.x = _grid.x - _maxField.width; _maxField.y = maxHeight + _linePlot.y - 10;
			_aveField.x = _maxField.x; _aveField.y = aveHeight + _linePlot.y - 10;
