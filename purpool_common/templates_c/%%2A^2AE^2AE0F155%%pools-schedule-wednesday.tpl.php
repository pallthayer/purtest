<?php /* Smarty version 2.6.19, created on 2010-03-25 06:37:33
         compiled from pools-schedule-wednesday.tpl */ ?>
<?php if (! $this->_tpl_vars['wednesday_route'] && ! $this->_tpl_vars['editmode']): ?>
<img src="images/table4.gif" /><br/>
  <table class="table4 ">
    <tr class="tablehead">
        <th class="nowrap"><?php echo $this->_tpl_vars['datewednesday']; ?>
</th>
    </tr>
    <tr>
...
<table class="table4 ">
    <tr class="tablehead">
        <th class="nowrap" colspan="4"><?php echo $this->_tpl_vars['datewednesday']; ?>
</th>
    </tr>
            <tr>
...
"><?php echo $this->_tpl_vars['members'][$this->_sections['info']['index']]['name']; ?>
            ...
            <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['wednesdayconfirm'] == 'accept'): ?>
                <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['editable']): ?>
                	<div id="<?php echo $this->_tpl_vars['fulldates'][3]; ?>
...
_icon" class="leftcell">
                ...
                <?php endif; ?>
            <?php endif; ?>
            <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['wednesdayconfirm'] == 'decline'): ?>
                <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['editable']): ?>
                    <div id="<?php echo $this->_tpl_vars['fulldates'][3]; ?>
_usericon" class="leftcell">
...
_icon" class="leftcell">
                ...
                <?php endif; ?>
            <?php endif; ?>
            <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['wednesdayconfirm'] == ''): ?>
                <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['editable']): ?>
                    <div id="<?php echo $this->_tpl_vars['fulldates'][3]; ?>
_usericon" class="leftcell">
...
'); return false;" href="#" 
                ...
                <?php else: ?>
                	<?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['wednesdayconfirm'] == 'accept'): ?><div class="rightcell accept">Accept</div><?php endif; ?>
                    <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['wednesdayconfirm'] == 'decline'): ?><div class="rightcell decline">Decline</div><?php endif; ?>
                    <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['wednesdayconfirm'] == ''): ?><div class="rightcell decline">Unconfirmed</div><?php endif; ?>
                <?php endif; ?>
             <?php endif; ?>
            </div>        
    <?php endfor; endif; ?>
...
" <?php if ($this->_tpl_vars['wednesday_route'] == $this->_tpl_vars['routes'][$this->_sections['info']['index']]['route_id']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['routes'][$this->_sections['info']['index']]['title']; ?>
</option>
                        <?php endfor; endif; ?>
                    </select>
                    <div id="wednesdayRouteError" class="formerror"><?php echo $this->_tpl_vars['error']['route']; ?>
</div>
                    </div>
...
" <?php if ($this->_tpl_vars['wednesdaydriver'] == $this->_tpl_vars['members'][$this->_sections['info']['index']]['user_id']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['members'][$this->_sections['info']['index']]['name']; ?>
</option>
                        <?php endfor; endif; ?>
                    </select>
                	...
                	<div id="wednesdayDriverError" class="formerror"><?php echo $this->_tpl_vars['error']['driver']; ?>
</div>
                	</div>
               </td>   
                <td class="nowrap" style="width:25%">
                    ...
                    <select name="wednesday_dm_hour" class="select" style="width: auto">
                        <option value="1" <?php if ($this->_tpl_vars['wednesday_dm_hour'] == '1'): ?>selected="selected"<?php endif; ?>>1</option>
                        <option value="2" <?php if ($this->_tpl_vars['wednesday_dm_hour'] == '2'): ?>selected="selected"<?php endif; ?>>2</option>
                        <option value="3" <?php if ($this->_tpl_vars['wednesday_dm_hour'] == '3'): ?>selected="selected"<?php endif; ?>>3</option>
                        <option value="4" <?php if ($this->_tpl_vars['wednesday_dm_hour'] == '4'): ?>selected="selected"<?php endif; ?>>4</option>
                        <option value="5" <?php if ($this->_tpl_vars['wednesday_dm_hour'] == '5'): ?>selected="selected"<?php endif; ?>>5</option>
                        <option value="6" <?php if ($this->_tpl_vars['wednesday_dm_hour'] == '6'): ?>selected="selected"<?php endif; ?>>6</option>
                        <option value="7" <?php if ($this->_tpl_vars['wednesday_dm_hour'] == '7'): ?>selected="selected"<?php endif; ?>>7</option>
                        <option value="8" <?php if ($this->_tpl_vars['wednesday_dm_hour'] == '8'): ?>selected="selected"<?php endif; ?>>8</option>
                        <option value="9" <?php if ($this->_tpl_vars['wednesday_dm_hour'] == '9'): ?>selected="selected"<?php endif; ?>>9</option>
                        <option value="10" <?php if ($this->_tpl_vars['wednesday_dm_hour'] == '10'): ?>selected="selected"<?php endif; ?>>10</option>
                        <option value="11" <?php if ($this->_tpl_vars['wednesday_dm_hour'] == '11'): ?>selected="selected"<?php endif; ?>>11</option>
                    ...
                    <select name="wednesday_dm_minute" class="select" style="width: auto">
                        <option value="00" <?php if ($this->_tpl_vars['wednesday_dm_minute'] == '00'): ?>selected="selected"<?php endif; ?>>00</option>
                        <option value="05" <?php if ($this->_tpl_vars['wednesday_dm_minute'] == '05'): ?>selected="selected"<?php endif; ?>>05</option>
                        <option value="10" <?php if ($this->_tpl_vars['wednesday_dm_minute'] == '10'): ?>selected="selected"<?php endif; ?>>10</option>
                        <option value="15" <?php if ($this->_tpl_vars['wednesday_dm_minute'] == '15'): ?>selected="selected"<?php endif; ?>>15</option>
                        <option value="20" <?php if ($this->_tpl_vars['wednesday_dm_minute'] == '20'): ?>selected="selected"<?php endif; ?>>20</option>
                        <option value="25" <?php if ($this->_tpl_vars['wednesday_dm_minute'] == '25'): ?>selected="selected"<?php endif; ?>>25</option>
                        <option value="30" <?php if ($this->_tpl_vars['wednesday_dm_minute'] == '30'): ?>selected="selected"<?php endif; ?>>30</option>
                        <option value="35" <?php if ($this->_tpl_vars['wednesday_dm_minute'] == '35'): ?>selected="selected"<?php endif; ?>>35</option>
                        <option value="40" <?php if ($this->_tpl_vars['wednesday_dm_minute'] == '40'): ?>selected="selected"<?php endif; ?>>40</option>
                        <option value="45" <?php if ($this->_tpl_vars['wednesday_dm_minute'] == '45'): ?>selected="selected"<?php endif; ?>>45</option>
                        <option value="50" <?php if ($this->_tpl_vars['wednesday_dm_minute'] == '50'): ?>selected="selected"<?php endif; ?>>50</option>
                        <option value="55" <?php if ($this->_tpl_vars['wednesday_dm_minute'] == '55'): ?>selected="selected"<?php endif; ?>>55</option>
                    </select>
                    <select name="wednesday_dm_ampm" class="select" style="width: auto">
                        <option value="am" <?php if ($this->_tpl_vars['wednesday_dm_ampm'] == 'am'): ?>selected="selected"<?php endif; ?>>am</option>
                        <option value="pm" <?php if ($this->_tpl_vars['wednesday_dm_ampm'] == 'pm'): ?>selected="selected"<?php endif; ?>>pm</option>
                    </select>
                    </div>
	                ...
	                <td style="width:25%">
	                    ...
	                    <input name="wednesday_notes" type="text" maxlength="255" value="<?php echo $this->_tpl_vars['wednesday_notes']; ?>
" class="textbox" />
	                    <!--<textarea id="message" name="wednesday_notes" class="textbox" value="<?php echo $this->_tpl_vars['wednesday_notes']; ?>
...
" />
                <input name="rdate" type="hidden" value="<?php echo $this->_tpl_vars['fulldates'][3]; ?>
" />
...
&rdate=<?php echo $this->_tpl_vars['wednesday_ride']; ?>
">
...
$this->_sections['info']['last']       = ($this->_sections['info']['iteration'] == $this->_sections['info']['total']);
?>
                            <?php if ($this->_tpl_vars['wednesday_route'] == $this->_tpl_vars['routes'][$this->_sections['info']['index']]['route_id']): ?><?php echo $this->_tpl_vars['routes'][$this->_sections['info']['index']]['title']; ?>
<?php endif; ?>
                        <?php endfor; endif; ?>
                    </div>
                	<div class="formelement">
...
$this->_sections['info']['last']       = ($this->_sections['info']['iteration'] == $this->_sections['info']['total']);
?>
                            <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['wednesdaydriver'] == $this->_tpl_vars['members'][$this->_sections['info']['index']]['user_id']): ?><?php echo $this->_tpl_vars['members'][$this->_sections['info']['index']]['name']; ?>
<?php endif; ?>
                        <?php endfor; endif; ?>
                    </div>
                </td>
...
&nbsp;<?php echo $this->_tpl_vars['wednesday_dm_ampm']; ?>
                    ...
                    <span class="purple">Arrive at Workplace</span><br />
                        <?php echo $this->_tpl_vars['wednesday_aw_hour']; ?>
...
&nbsp;<?php echo $this->_tpl_vars['wednesday_dw_ampm']; ?>
                ...
                <td>
                	<label for="wednesday_notes">Additional Notes</label>
	                    <input name="wednesday_notes" type="text" maxlength="255" readonly="readonly" value="<?php echo $this->_tpl_vars['wednesday_notes']; ?>
" class="textbox" />
	               <span class="btn" >
                    <a href="pools.php?state=viewitinerary&pool=<?php echo $this->_tpl_vars['pool_id']; ?>
&rdate=<?php echo $this->_tpl_vars['wednesday_ride']; ?>
