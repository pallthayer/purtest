<?php /* Smarty version 2.6.19, created on 2010-03-25 06:37:33
         compiled from pools-schedule-monday.tpl */ ?>
<?php if (! $this->_tpl_vars['monday_route'] && ! $this->_tpl_vars['editmode']): ?>
<img src="images/table4.gif" /><br/>
  <table class="table4 ">
    <tr class="tablehead">
        <th class="nowrap"><?php echo $this->_tpl_vars['datemonday']; ?>
</th>
    </tr>
    <tr>
...
<table class="table4 ">
    <tr class="tablehead">
        <th class="nowrap" colspan="4"><?php echo $this->_tpl_vars['datemonday']; ?>
</th>
    </tr>
            <tr>
...
"><?php echo $this->_tpl_vars['members'][$this->_sections['info']['index']]['name']; ?>
            ...
            <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['mondayconfirm'] == 'accept'): ?>
                <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['editable']): ?>
                	<div id="<?php echo $this->_tpl_vars['fulldates'][1]; ?>
...
_icon" class="leftcell">
                ...
                <?php endif; ?>
            <?php endif; ?>
            <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['mondayconfirm'] == 'decline'): ?>
                <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['editable']): ?>
                    <div id="<?php echo $this->_tpl_vars['fulldates'][1]; ?>
_usericon" class="leftcell">
...
_icon" class="leftcell">
                ...
                <?php endif; ?>
            <?php endif; ?>
            <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['mondayconfirm'] == ''): ?>
                <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['editable']): ?>
                    <div id="<?php echo $this->_tpl_vars['fulldates'][1]; ?>
_usericon" class="leftcell">
...
'); return false;" href="#" 
                ...
                <?php else: ?>
                	<?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['mondayconfirm'] == 'accept'): ?><div class="rightcell accept">Accept</div><?php endif; ?>
                    <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['mondayconfirm'] == 'decline'): ?><div class="rightcell decline">Decline</div><?php endif; ?>
                    <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['mondayconfirm'] == ''): ?><div class="rightcell decline">Unconfirmed</div><?php endif; ?>
                <?php endif; ?>
             <?php endif; ?>
            </div>        
    <?php endfor; endif; ?>
...
" <?php if ($this->_tpl_vars['monday_route'] == $this->_tpl_vars['routes'][$this->_sections['info']['index']]['route_id']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['routes'][$this->_sections['info']['index']]['title']; ?>
</option>
                        <?php endfor; endif; ?>
                    </select>
                    <div id="mondayRouteError" class="formerror"><?php echo $this->_tpl_vars['error']['route']; ?>
</div>
                    </div>
...
" <?php if ($this->_tpl_vars['mondaydriver'] == $this->_tpl_vars['members'][$this->_sections['info']['index']]['user_id']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['members'][$this->_sections['info']['index']]['name']; ?>
</option>
                        <?php endfor; endif; ?>
                    </select>
                	<div id="mondayDriverError" class="formerror"><?php echo $this->_tpl_vars['error']['driver']; ?>
</div>
                	</div>
               </td>   
                <td class="nowrap" style="width:25%">
                    ...
                    <select name="monday_dm_minute" class="select" style="width: auto">
                        ...
                        <option value="15" <?php if ($this->_tpl_vars['monday_dm_minute'] == '15'): ?>selected="selected"<?php endif; ?>>15</option>
	                ...
	                <td style="width:25%">
	                    ...
	                    <input name="monday_notes" type="text" maxlength="255" value="<?php echo $this->_tpl_vars['monday_notes']; ?>
" class="textbox" />
	                    <!--<textarea id="message" name="monday_notes" class="textbox" value="<?php echo $this->_tpl_vars['monday_notes']; ?>
...
" />
                <input name="rdate" type="hidden" value="<?php echo $this->_tpl_vars['fulldates'][1]; ?>
" />
...
&rdate=<?php echo $this->_tpl_vars['monday_ride']; ?>
">
...
$this->_sections['info']['last']       = ($this->_sections['info']['iteration'] == $this->_sections['info']['total']);
?>
                            <?php if ($this->_tpl_vars['monday_route'] == $this->_tpl_vars['routes'][$this->_sections['info']['index']]['route_id']): ?><?php echo $this->_tpl_vars['routes'][$this->_sections['info']['index']]['title']; ?>
<?php endif; ?>
                        <?php endfor; endif; ?>
                    </div>
                	<div class="formelement">
...
$this->_sections['info']['last']       = ($this->_sections['info']['iteration'] == $this->_sections['info']['total']);
?>
                            <?php if ($this->_tpl_vars['members'][$this->_sections['info']['index']]['mondaydriver'] == $this->_tpl_vars['members'][$this->_sections['info']['index']]['user_id']): ?><?php echo $this->_tpl_vars['members'][$this->_sections['info']['index']]['name']; ?>
<?php endif; ?>
                        <?php endfor; endif; ?>
                    </div>
                </td>
...
&nbsp;<?php echo $this->_tpl_vars['monday_dm_ampm']; ?>
                    ...
                    <span class="purple">Arrive at Workplace</span><br />
                        <?php echo $this->_tpl_vars['monday_aw_hour']; ?>
...
&nbsp;<?php echo $this->_tpl_vars['monday_dw_ampm']; ?>
                ...
                <td>
                	<label for="monday_notes">Additional Notes</label>
	                    <input name="monday_notes" type="text" maxlength="255" readonly="readonly" value="<?php echo $this->_tpl_vars['monday_notes']; ?>
" class="textbox" />
	               <span class="btn" >
                    <a href="pools.php?state=viewitinerary&pool=<?php echo $this->_tpl_vars['pool_id']; ?>
&rdate=<?php echo $this->_tpl_vars['monday_ride']; ?>
