<?php /* Smarty version 2.6.19, created on 2009-04-15 08:20:45
         compiled from wkplaceadmin-manageannouncements.tpl */ ?>
...
unset($_smarty_tpl_vars);
 ?>
        ...
        <div class="content">
        	...
        	<!-- Back to Main Menu -->
            <p><a href="wkplaceadmin.php">Back to Main Menu</a></p>
...
" />
                ...
                <div class="formelement">
                    ...
                    Send announcement to purpool users associated with your place via e-mail?
...
?>
 ...
 - <?php echo $this->_tpl_vars['announcements'][$this->_sections['info']['index']]['enddate']; ?>
                            ...
                            <td>
                                <a href="wkplaceadmin.php?state=deleteannouncement&announcement=<?php echo $this->_tpl_vars['announcements'][$this->_sections['info']['index']]['announcement_id']; ?>
">Delete</a>
                            </td>
                        </tr>
                    <?php endfor; endif; ?>
            ...
            <?php else: ?>
            	<p>There are currently no Purpool announcements associated with this workplace.</p>
            <?php endif; ?>
