<?php /* Smarty version 2.6.19, created on 2008-07-17 09:03:02
         compiled from createride.tpl */ ?>
...
" alt="" />
        ...
        <ul id="leftnav">
            ...
            <li><a href="admin.php?state=createride" class="current">Create a Ride</a></li>
    ...
    <div id="rightcolumn">
        ...
        <form id="rideForm" method="post" action="admin.php?state=createride">
            ...
            <div class="formelement">
                ...
                <input id="rideTitle" name="rideTitle" type="text" value="" maxlength="100" class="textbox" />
            ...
            <div class="formelement">
                ...
                <input id="startAddress1" name="startAddress1" type="text" value="" maxlength="100" class="textbox" />

                <span id="startAddress1Error" class="formerror"><?php echo $this->_tpl_vars['error']['startAddress1']; ?>
</span><br />

                <input id="startAddress2" name="startAddress2" type="text" value="" maxlength="100" class="textbox" style="margin-top: 5px;" />
            ...
            <div class="formelement">
                ...
                <input id="startCity" name="startCity" type="text" value="" maxlength="100" class="textbox" />
            ...
            <div class="formelement">
                ...
                <input id="startZip" name="startZip" type="text" value="" maxlength="100" class="textbox" />
            ...
            <div class="formelement">
                ...
                <input id="endAddress1" name="endAddress1" type="text" value="" maxlength="100" class="textbox" />

                <span id="endAddress1Error" class="formerror"><?php echo $this->_tpl_vars['error']['endAddress1']; ?>
</span><br />

                <input id="endAddress2" name="endAddress2" type="text" value="" maxlength="100" class="textbox" style="margin-top: 5px;" />
            ...
            <div class="formelement">
                ...
                <input id="endCity" name="endCity" type="text" value="" maxlength="100" class="textbox" />
            ...
            <div class="formelement">
                ...
                <input id="endZip" name="endZip" type="text" value="" maxlength="100" class="textbox" />
            ...
            <!-- Submit Button -->
           	...
           	<div class="formelement">
                ...
                <input id="submit" name="submit" type="submit" value="Create Ride" class="submit" />
