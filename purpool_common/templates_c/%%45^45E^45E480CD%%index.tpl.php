<?php /* Smarty version 2.6.19, created on 2011-08-18 16:25:14
...
" id="logo"><h1>Purpool</h1></a>
    ...
    <div id="topnav2">
		...
		<div class="innercolumn" style="width: 200px">
	   		 <h3>Purpool Stats</h3>
	    		 Purpool currently has <?php echo $this->_tpl_vars['activemembers']; ?>
 active members, and <?php echo $this->_tpl_vars['poolcount']; ?>
 registered carpools - join us today!
                </div> 
            <?php else: ?>
                <div class="innercolumn" style="width: 200px">
...
$this->_sections['info']['loop'] = is_array($_loop=$this->_tpl_vars['leaders']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
                            <tr style="border: none;">
                                <td style="border: none;"><?php echo $this->_tpl_vars['leaders'][$this->_sections['info']['index']]['team']; ?>
<br />(<?php echo $this->_tpl_vars['leaders'][$this->_sections['info']['index']]['workplace']; ?>
)</td>
                                <td style="border: none;">Rank: <?php echo $this->_tpl_vars['leaders'][$this->_sections['info']['index']]['rank']; ?>
</td>
                            </tr>
                        <?php endfor; endif; ?>
                    </table>
