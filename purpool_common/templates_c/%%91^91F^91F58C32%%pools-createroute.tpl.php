<?php /* Smarty version 2.6.19, created on 2011-09-07 17:17:47
         compiled from pools-createroute.tpl */ ?>
...
function addRoutePost(e)
{
	...
	new PeriodicalExecuter(function(pe) 
	{
		if ((distance != \'\') && (vertices != \'\'))
		{
			...
			// Send AJAX request
			var url = \'pools.php?state=saveroute&pool=\' + $(\'pool\').value;
...
function addRouteResponse(resp)
{
	...
	{
		// Redirect user
		window.location = \'pools.php?state=viewroutes&pool=\' + json.pool + \'&confirmation=createpool\';
	}
...
" maxlength="100" class="textbox" />
                ...
                <!-- Submit Button -->
                <div class="formelement">
                    <input id="submit" name="submit" type="submit" value="Create Route" class="submit" />
                </div>
