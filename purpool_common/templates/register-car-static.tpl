...
<body>
    ...
    <div id="topnav2">
        ...
        <div id="wizard">
        	<ul>
           	  <li><a href="register.php"><span>1. General</span></a></li>
        ...
        <!-- General Form -->
        <form id="myform" method="post" action="register.php?state=car">
            ...
            <div id="make_container" class="formelement">
                ...
                <select id="make" name="make" class="select">
                    ...
                    {foreach from=$makes item=make name=myloop}
                        <option value="{$make}" {if $make eq $selectedmake}selected="selected"{/if}>{$make}</option>
                    {/foreach}
                </select>
            ...
            <div id="model_container" class="formelement">
                ...
                {foreach from=$models item=model name=myloop}
                    <option value="{$model}" {if $model eq $selectedmodel}selected="selected"{/if}>{$model}</option>
                {/foreach}
            ...
            <div id="trans_container" class="formelement">
                ...
                <select id="trans" name="trans" class="select">
                    ...
                    {foreach from=$trans item=tran name=myloop}
                        <option value="{$tran}" {if $tran eq $selectedtran}selected="selected"{/if}>{$tran}</option>
                    {/foreach}
                </select>
            ...
            <div id="cylinders_container" class="formelement">
                ...
                <select id="cylinders" name="trans" class="select">
                    <option value="" selected="selected"> -- select -- </option>
                    {foreach from=$cylinders item=cylinder name=myloop}
                        <option value="{$cylinder}" {if $cylinder eq $selectedcylinder}selected="selected"{/if}>{$cylinder}</option>
                    {/foreach}
                </select>
