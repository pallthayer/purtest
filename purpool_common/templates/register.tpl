...
<body>
    ...
    <div id="topnav2">
        ...
        <div class="content">
            ...
            {if $error.unexpected}<p style="formerror">{$error.unexpected}</p>{/if}
            ...
            <form id="myform" method="post" enctype="multipart/form-data" action="register.php">
                ...
                <div class="formelement">
                    ...
                    <input id="username" name="username" type="text" value="{$username}" maxlength="50" style="width:320px;" class="textbox" />
