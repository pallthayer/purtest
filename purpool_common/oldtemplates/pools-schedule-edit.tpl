			...
			<div class="innercolumn3 clear">
	            ...
	            <form id="daysform" method="post" action="pools.php?state=editschedule&pool={$pool_id}">
	                ...
	                <table class="table3">
	                	...
	                	<td>
	                <!-- Days checkboxes -->
	                    <input id="monday" name="monday" type="checkbox" value="y" {if $monday == 'y'}checked="checked"{/if} /> Monday <br />
	                    </td>                
	                ...
	                <tr>
	                <td>
	                    <input id="tuesday" name="tuesday" type="checkbox" value="y" {if $tuesday == 'y'}checked="checked"{/if} /> Tuesday
	                </td>
	                <td>
	                ...
	                <tr>
	                <td>
	                    <input id="wednesday" name="wednesday" type="checkbox" value="y" {if $wednesday == 'y'}checked="checked"{/if} /> Wednesday 
	                    </td>
	                <td>
	                <!-- wednesday -->
	                ...
	                <tr>
	                <td>
	                    <input id="thursday" name="thursday" type="checkbox" value="y" {if $thursday == 'y'}checked="checked"{/if} /> Thursday
	                    </td>
	                    <td>
	                    ...
	                    <tr>
	                    <td>
	                    <input id="friday" name="friday" type="checkbox" value="y" {if $friday == 'y'}checked="checked"{/if} /> Friday 
	                    </td>
	                    <td>
	                ...
	                <tr>
	                <td>
	                    <input id="saturday" name="saturday" type="checkbox" value="y" {if $saturday == 'y'}checked="checked"{/if} /> Saturday
	                    </td>
	                    <td>
	                ...
	                <tr>
	                <td>
	                    <input id="sunday" name="sunday" type="checkbox" value="y" {if $sunday == 'y'}checked="checked"{/if} /> Sunday
	                </td>
	                <td>
	                ...
	                <div class="formelement">
	                	...
	                	<span name="oldstart">{$oldstart}</span>
	                </div>
