               ...
               <div id="vehiclewrapper">
                    ...
                    <div id="make_container" class="formelement">
                        ...
                        <select id="make" name="make" class="select">
                            ...
                            {foreach from=$makes item=make name=myloop}
                                <option value="{$make}" {if $currentmake eq $make}selected="selected"{/if}>{$make}</option>
                            {/foreach}
                        </select>
                    ...
                    <div id="model_container" class="formelement">
                        ...
                        <select id="model" name="model" class="select">
                            ...
                            {foreach from=$models item=model name=myloop}
                                <option value="{$model}" {if $currentmodel eq $model}selected="selected"{/if}>{$model}</option>
                            {/foreach}
                        </select>
                    ...
                    <div id="trans_container" class="formelement">
                        ...
                        <select id="trans" name="trans" class="select">
                            <option value=""> -- select -- </option>
                            {foreach from=$trans item=trans name=myloop}
                                <option value="{$trans}" {if $currenttrans eq $trans}selected="selected"{/if}>{$trans}</option>
                            {/foreach}
                        </select>
                    ...
                    <div id="cylinders_container" class="formelement">
                        ...
                        <select id="cylinders" name="cylinders" class="select">
                            <option value=""> -- select -- </option>
                            {foreach from=$cylinders item=cylinders name=myloop}
                                <option value="{$cylinders}" {if $currentcylinders eq $cylinders}selected="selected"{/if}>{$cylinders}</option>
                            {/foreach}
                        </select>
